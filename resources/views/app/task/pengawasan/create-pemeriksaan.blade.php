...
@endpush
@section('header')
    <x-header title="Input Task Assurance (Pemeriksaan)"></x-header>
@endsection
@section('content')
    <div class="col-lg-8">
        <form id="form_pemeriksaan" enctype="multipart/form-data">
            ...
            @if ($surat_masuk)
                ...
                <input hidden value="assurance" name="jenis_pengawasan">
            @endif
            @if ($surat_masuk == null)
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <select id="jenis_pengawasan" name="jenis_pengawasan" required type=""
                                ...
                                <option selected value="assurance">Assurance (Pemeriksaan)</option>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
                            <x-select2 id="sifat_penugasan" label="Sifat Penugasan" required='true'
                                placeholder="Pilih Sifat Penugasan">
                                <option value="">-- Pilih Sifat Penugasan --</option>
                                <option value="Reguler">Reguler</option>
                                <option value="Khusus">Khusus</option>
                            </x-select2>
                            <x-select2 id="assurance_jenis_id" label="Jenis Assurance" required="true"
                                placeholder="Pilih Jenis Penugasan">
                                <option  value="">-- Pilih Jenis Assurance --</option>
                            ...
                            {{-- <x-input id='' label='Lama Waktu Pelaksanaan' required=true /> --}}
                        </div>
                    </div>
                </div>
        ...
        $("#form_pemeriksaan").submit(function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: @json(route('pemeriksaan.store')),
                        data: formData,
                        cache: false,
                        contentType: false,
                        processData: false,
                        ...
                        success: (response) => {
                            if (response) {
                                ...
                                Swal.fire({
                                    ...
                                    swal.hideLoading()
                                    window.location.replace(@json(route('pemeriksaan.index')))
                                })
                                swal.hideLoading()
                            }
                        },
