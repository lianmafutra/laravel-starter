...
@section('header')
    <x-header title="Task Pengawasan - Pemeriksaan"></x-header>
@endsection
@section('content')
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <a href="{{ route('pemeriksaan.create') }}" class="btn btn-sm btn-primary"><i class="fas fa-plus"></i> Input
                    Data</a>
            </div>
            <div class="card-body">
...
@push('js')
    ...
    <script>
        let datatable = $("#datatable").DataTable({
            ...
            ajax: @json(route('pemeriksaan.index')),
