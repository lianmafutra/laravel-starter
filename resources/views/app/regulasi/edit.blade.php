...
@endpush
@section('header')
    <x-header title="Edit Regulasi"></x-header>
@endsection
@section('content')
    <div class="col-lg-6">
        <div class="card">
            <form id="form_regulasi" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
                           <input hidden value="{{ $regulasi->id }}" name="id">
                            <x-input  value="{{ $regulasi->judul }}"
...
@push('js')
    ...
    <script>
        ...
        $('#jenis').val(@json($regulasi->jenis)).trigger("change")

        if (@json($regulasi->file_regulasi) != null) {
         file_regulasi.setOptions({
                storeAsFile: true,
                allowDownloadByUrl: true,
                files: [{
                    source: @json($regulasi->file_regulasi_r != null ? $regulasi->file_regulasi_r->file_url : ''),
                }]
            });
        }
